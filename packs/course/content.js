  ...
  glossary: [
    ...
    },
    {
      ...
      rows: [
        ...
        ["Label latency", "The delay between a prediction and the arrival of its ground truth, which bounds how fast retraining can help.", "Renewal, repayment, appeals, and other outcomes observed later.", "\"labels arrive weeks after predictions, so immediate monitoring uses clearly labelled proxies\""],
