...
<li><b>Network layers.</b> Network software is described as a stack of layers, each one using the layer below it and hiding its detail. Two of them come up constantly here. <b>Layer 4</b> is the <b>transport layer</b>, where a connection is nothing more than an address and a port, carried by TCP or UDP; software at this layer moves bytes and never looks at what they mean. <b>Layer 7</b> is the <b>application layer</b>, where the message itself is visible - an HTTP request with a method, a path, headers and a body. The numbers come from the OSI (Open Systems Interconnection) reference model, an old seven-layer diagram nobody implements literally, but layer 4 and layer 7 stuck as the everyday names for "below the message" and "the message itself."</li>
