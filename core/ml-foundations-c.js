...
<li><b>GAN (generative adversarial network), VAE (variational autoencoder), diffusion model</b> - three families of generative model that learn to produce new examples resembling the training data, each optimising a different objective.</li>
