...
<li><b>KL divergence</b> - a number measuring how far one probability distribution has moved from another. Used here as a penalty term that keeps a model being tuned from drifting far from the model it started as.</li>
...
<li><b>LLM-as-judge</b> - using a strong model to read and score another model's outputs, so a human does not have to score every single one.</li>
...
<li><b>KV cache</b> - the stored key and value tensors from every previous token, kept so decode does not have to reprocess the whole prompt from scratch on every step.</li>
...
<li><b>Serving runtime</b> - the software that turns a trained model into a server that accepts requests and streams tokens back, such as vLLM or TensorRT-LLM.</li>
</ul>`,
