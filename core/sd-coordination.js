...
<li><b>TTL (time to live).</b> How long a cached value is allowed to be served before it must be treated as too old and refetched from the origin.</li>
<li><b>Eviction.</b> Removing an entry from the cache to make room for another, chosen by an <b>eviction policy</b> such as LRU or LFU.</li>
...
<li><b>CAP theorem.</b> During a network partition, a system must choose between staying consistent and staying available; it says nothing about normal operation when there is no partition.</li>
